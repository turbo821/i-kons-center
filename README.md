...
Веб-приложение для построения дашбордов, виджетов и KPI на основе данных из различных источников. Концептуально аналогично Microsoft Power BI и Visiology, но спроектировано с учётом специфики отрасли — в том числе поддерживает KPI с направлением «меньше — лучше» (для показателей безопасности и аварийности) и гибкое разграничение доступа на основе ролевых групп.
...
- Базовые глобальные роли (`admin`, `viewer`)
...
- `viewer` — базовая роль, назначается автоматически при регистрации; сама по себе не открывает доступа к данным.
